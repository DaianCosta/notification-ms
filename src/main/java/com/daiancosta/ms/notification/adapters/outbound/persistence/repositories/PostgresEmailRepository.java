...
public class PostgresEmailRepository implements EmailRepositoryPort {
    ...
    public Email save(Email email) {
        final EmailEntity emailEntity = emailRepository.save(modelMapper.map(email, EmailEntity.class));
    ...
    public Optional<Email> findById(UUID emailId) {
        final Optional<EmailEntity> emailEntity = emailRepository.findById(emailId);
